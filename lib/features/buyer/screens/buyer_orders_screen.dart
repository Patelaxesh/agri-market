...
import 'package:agrimarket/features/buyer/screens/buyer_track_order_screen.dart';
...
width: 60,
decoration: BoxDecoration(
color: BuyerOrdersScreen.primaryColor.withValues(alpha: 0.1), // Updated to withValues
...
context,
MaterialPageRoute(
builder: (context) => const BuyerTrackOrderScreen(),
),
);
}
},
...
decoration: BoxDecoration(
color: color.withValues(alpha: 0.1), // Maintained withValues here
