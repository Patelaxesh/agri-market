...
class DashboardBanners extends StatefulWidget {
  const DashboardBanners({super.key});

  @override
  State<DashboardBanners> createState() => _DashboardBannersState();
}

class _DashboardBannersState extends State<DashboardBanners> {
  int _currentIndex = 0;
